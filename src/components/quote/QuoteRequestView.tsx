...
export default function QuoteRequestView({ models, advisors }: Props) {
    ...
    const trimParam   = searchParams.get('trim')   ?? undefined;
    ...
    return (
        <section id="cotizar" className="bg-[#0A110F] py-24 relative overflow-hidden flex items-center border-t border-white/5">
            <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#00D4AA]/5 rounded-full blur-[100px] pointer-events-none" />
